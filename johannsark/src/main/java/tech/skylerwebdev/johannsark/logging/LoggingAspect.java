package tech.skylerwebdev.johannsark.logging;
...
{
    @Around(value = "@within(tech.skylerwebdev.johannsark.logging.Loggable) || @annotation(tech.skylerwebdev.johannsark.logging.Loggable)")
